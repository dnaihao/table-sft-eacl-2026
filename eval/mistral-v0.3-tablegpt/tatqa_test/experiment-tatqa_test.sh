...
llamafactory-cli train /code/table-sft/saves/mistral-finetune/experiment-2118-mistral-lr-5.0e-7-tablegpt_large/checkpoint-5589/evaluations/tatqa_test/experiment-tatqa_test.yaml
