...
llamafactory-cli train /code/table-sft/saves/mistral-finetune/experiment-11000-mistral-lr-5.0e-7-tablellm_train/checkpoint-13602/evaluations/wikitq_test/experiment-wikitq_test.yaml
