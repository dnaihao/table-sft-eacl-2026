...
llamafactory-cli train /code/table-sft/saves/mistral-finetune/experiment-3304-mistral-lr-5.0e-7-tablebench_tableinstruct/checkpoint-1659/evaluations/tatqa_test/experiment-tatqa_test.yaml
